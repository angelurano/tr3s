  ...
  if (collapsible === 'none') {
    return (
      <div
        data-slot='sidebar'
        className={cn(
          'bg-secondary-background text-foreground w-(--sidebar-width) flex h-full flex-col',
          className
        )}
        {...props}
      >
      ...
      <div
        ...
        className={cn(
          ...
          variant === 'floating' || variant === 'inset'
            ...
            : 'group-data-[collapsible=icon]:w-(--sidebar-width-icon) border-r-border border-l-border group-data-[side=left]:border-r-2 group-data-[side=right]:border-l-2',
          className
        )}
        {...props}
      >
  ...
  return (
    <main
      ...
      className={cn(
        ...
        'md:peer-data-[variant=inset]:rounded-base md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2 md:peer-data-[variant=inset]:shadow-sm',
        className
      )}
      {...props}
    />
...
function SidebarGroupLabel({
  ...
  return (
    <Comp
      ...
      className={cn(
        'text-foreground ring-ring rounded-base font-heading outline-hidden flex h-8 shrink-0 items-center px-2 text-sm transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        'rounded-base outline-hidden absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center p-0 transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        '[&_svg]:text-foreground hover:[&_svg]:text-main-foreground text-main-foreground hover:bg-main hover:outline-border rounded-base absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center p-0 outline-2 outline-transparent transition-transform focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0',
        // Increases the hit area of the button on mobile.
        'after:absolute after:-inset-2 md:after:hidden',
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        'text-foreground rounded-base font-base pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center px-1 text-xs tabular-nums',
